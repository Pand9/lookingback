...
variables=(EASYTRACK_ALERT_METHOD EASYTRACK_LOG_OUTPUT EASYTRACK_PYTHON_VENV_ACTIVATE EASYTRACK_SH_SOURCE_PATH EASYTRACK_PY_SOURCE_PATH EASYTRACK_RUST_SOURCE_PATH EASYTRACK_RUST_REDUCER_BIN_PATH EASYTRACK_RUST_CARGO_RUN_ARGS)
